  ...
  ngOnInit() {
    this.route.params
      .subscribe(
        (params: Params) => {
          this.id = +params['id'];
          // Si existe id en la url sera porque estamos en modo edicion, sino sera undefined.
    ...
    if (this.editMode) {
      this.store.select('recipes')
        ...
        .subscribe((recipeState: fromRecipe.State) => {
          ...
          if (recipe['ingredients']) { // Ver si tiene ingredientes definidos, si no es undefined
